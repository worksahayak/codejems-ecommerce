...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Color/</span> Edit</h4>

    <div class="row">
        <div class="col-xl">
            <div class="card p-4">
                <form method="post" action="{{ route('admin.color.update', ['id' => $color->id]) }}" id="categoryForm">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label" for="name">Color Name</label>
                        <input type="text" name="name" class="form-control" id="name" placeholder="Color Name" value="{{ $color->name }}" />
                    </div>

                    <div class="mb-3">
                        <label class="form-label" for="code">Parent Color</label>
                        <input type="text" name="code" class="form-control" id="code" placeholder="Color Code" value="{{ $color->code }}" />
                    </div>
